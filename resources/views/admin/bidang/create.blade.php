    ...
    <form action="{{ route('admin.bidang.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white p-6 sm:p-8 rounded-3xl shadow-xs border border-slate-200/80 space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" required value="{{ old('name') }}" placeholder="Contoh: Bidang Kepemudaan (Gema Keadilan)" class="w-full bg-slate-50 text-xs text-slate-800 rounded-xl px-4 py-3 border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#da251c] transition">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="icon" id="icon" value="{{ old('icon', 'fa-solid fa-laptop-code') }}" placeholder="Contoh: fa-solid fa-laptop-code atau /uploads/..." class="w-full bg-slate-50 text-xs text-slate-800 rounded-xl px-4 py-3 border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#00913e] font-mono">
                </div>
            </div>
