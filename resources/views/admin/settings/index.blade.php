            ...
            <div class="p-6 space-y-6">
                    ...
                    <div class="max-w-md bg-slate-50 rounded-2xl border border-gray-200 p-3.5 shadow-sm">
                        <div class="rounded-xl overflow-hidden border border-gray-200 bg-white">
                            <div class="h-40 bg-gray-100 flex items-center justify-center overflow-hidden relative">
                                <img id="ogPreviewImg" src="{{ asset($settings['og_image'] ?? '/uploads/logo-ishum.svg') }}" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="og_image" value="{{ $settings['og_image'] ?? '/uploads/logo-ishum.svg' }}" 
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                    ...
                    <div>
                        ...
                        <input type="text" name="site_logo" value="{{ $settings['site_logo'] ?? '/uploads/logo-ishum.svg' }}" class="w-full bg-gray-50 text-xs text-gray-800 rounded-xl px-4 py-3 border border-gray-200 font-mono">
                    </div>
                </div>
            </div>
        </div>
