        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
            <div class="lg:col-span-5 flex flex-col">
                <div class="w-full h-full min-h-[360px] sm:min-h-[420px] rounded-3xl overflow-hidden shadow-xl border-4 border-white ring-4 ring-emerald-100 bg-emerald-50 relative group flex flex-col">
                    <img src="{{ $siteSettings['mudir_photo'] ?? '/uploads/official/foto-mudir.webp' }}" alt="{{ $siteSettings['mudir_name'] ?? 'KH. Tol\'at Wafa Ahmad, Lc.' }} - Mudir Pesantren" class="w-full h-full object-cover object-top group-hover:scale-105 transition duration-500" onerror="this.onerror=null;this.src='/uploads/official/logo-ru-berwarna.png'">
