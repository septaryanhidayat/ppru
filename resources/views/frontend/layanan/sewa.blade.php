...
<div class="bg-slate-50/70 py-8 sm:py-12">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {{-- KOLOM KIRI (5 Kolom): INFORMASI FASILITAS & PROSEDUR SEWA (DINAMIS SESUAI ADMIN) --}}
            <div class="lg:col-span-5 space-y-4">
                ...
                <div class="p-5 rounded-3xl bg-gradient-to-r from-emerald-900 to-emerald-950 text-white space-y-2 shadow-sm">
                    <div class="flex items-center space-x-2 text-xs font-bold text-emerald-200">
                        ...
                        <span>Cek Ketersediaan Gedung &amp; Sarana</span>
                    </div>
                    <p class="text-[11px] text-emerald-100 font-light leading-relaxed">
                        Ingin cek kalender pemakaian aula atau laboratorium pada tanggal tertentu? Hubungi tim Sarpras kami.
                    </p>
                    <a href="https://wa.me/6281278901950?text={{ urlencode('Assalamu\'alaikum Tim Sarpras PPRU, saya ingin cek ketersediaan gedung aula/sarana.') }}" target="_blank" class="inline-flex items-center gap-2 text-xs font-bold text-amber-300 hover:text-white transition pt-1">
