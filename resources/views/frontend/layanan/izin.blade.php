                ...
                <div class="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-7 border border-slate-200/90 dark:border-slate-800 shadow-md flex flex-col justify-between flex-1 space-y-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="pb-3.5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                            <div>
                                <span class="text-[10px] font-black uppercase tracking-wider text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-slate-800 px-2.5 py-0.5 rounded-full border border-emerald-100 dark:border-slate-700">
                                    Panduan &amp; Spesifikasi
                                </span>
                            ...
                            <div class="w-8 h-8 rounded-xl bg-emerald-50 dark:bg-slate-800 text-[#00843d] dark:text-emerald-400 flex items-center justify-center text-sm font-bold shadow-xs">
            ...
            <div class="lg:col-span-7 flex flex-col">
                <div class="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 md:p-9 border border-slate-200/90 dark:border-slate-800 shadow-md space-y-6 flex-1 flex flex-col">
                    ...
                    <div class="pb-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                        <div>
                            <span class="text-[10px] font-black uppercase tracking-wider text-emerald-700 dark:text-emerald-400 block">Formulir Daring</span>
                            <h3 class="text-lg sm:text-xl font-black text-slate-900 dark:text-white tracking-tight mt-0.5">
                                Isi Formulir Permohonan Izin
                            </h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Lengkapi identitas pemohon dan lampirkan dokumen pendukung.</p>
                        </div>
                        <div class="w-9 h-9 rounded-xl bg-emerald-50 dark:bg-slate-800 text-[#00843d] dark:text-emerald-400 flex items-center justify-center text-sm shrink-0 border border-emerald-100 dark:border-slate-700" title="Koneksi Aman">
                            <i class="fa-solid fa-lock"></i>
                        </div>
                    </div>

                    <form action="{{ route('layanan.izin.submit') }}" method="POST" enctype="multipart/form-data" class="space-y-5 flex-1 flex flex-col justify-between">
                        @csrf
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="agency" id="agency" required value="{{ old('agency') }}" placeholder="Nama instansi pengaju" class="w-full bg-slate-50 dark:bg-slate-800 text-xs sm:text-sm text-slate-800 dark:text-slate-100 rounded-xl pl-9 pr-4 py-3 border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-[#00843d] focus:bg-white dark:focus:bg-slate-750 transition">
                                    </div>
                            ...
                            <div>
                                ...
                                <textarea name="purpose" id="purpose" rows="7" required placeholder="Tuliskan maksud kunjungan (studi banding kurikulum, observasi asrama, riset santri), tanggal rencana kunjungan, dan perkiraan jumlah rombongan..." class="w-full bg-slate-50 dark:bg-slate-800 text-xs sm:text-sm text-slate-800 dark:text-slate-100 rounded-xl p-3.5 border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-[#00843d] focus:bg-white dark:focus:bg-slate-750 transition leading-relaxed min-h-[170px] sm:min-h-[200px]">{{ old('purpose') }}</textarea>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                                <div class="bg-slate-50 dark:bg-slate-800 p-4 rounded-2xl border border-dashed border-slate-300 dark:border-slate-700 hover:border-[#00843d] transition">
                                    ...
                                    <input type="file" name="letter_file" required accept=".pdf,.doc,.docx,image/*" class="w-full text-xs text-slate-700 dark:text-slate-300 font-medium file:mr-2.5 file:py-1.5 file:px-3 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-[#00843d] file:text-white hover:file:bg-emerald-800 file:cursor-pointer transition">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 md:p-9 border border-slate-200/90 dark:border-slate-800 shadow-md">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-5 border-b border-slate-100 dark:border-slate-800">
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 rounded-2xl bg-emerald-100 dark:bg-emerald-950 text-[#00843d] dark:text-emerald-300 flex items-center justify-center text-lg font-bold">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 dark:text-slate-400">Kanal aspirasi, kritik membangun, dan pusat tindak lanjut pelayanan publik PPRU Sakatiga.</p>
                        </div>
                    </div>
