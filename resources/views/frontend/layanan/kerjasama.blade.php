    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div class="space-y-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-gray-200 pb-3">
                <div>
                    <h3 class="text-base sm:text-lg font-black text-gray-900">Ketentuan Permohonan Kerja Sama</h3>
                    <p class="text-xs text-gray-500">Panduan lengkap prosedur kemitraan strategis, syarat berkas, dan transparansi proses tanpa perlu klik buka-tutup.</p>
                </div>
