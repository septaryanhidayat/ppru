...
@endphp
        ...
        <div class="grid grid-cols-1 {{ $isSewaActive ? 'md:grid-cols-3' : 'md:grid-cols-2 max-w-4xl mx-auto' }} gap-6 sm:gap-7">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-3xl p-7 border border-slate-200/90 dark:border-slate-800 shadow-sm hover:shadow-xl hover:border-emerald-500 transition-all duration-300 flex flex-col justify-between group hover:-translate-y-1.5">
                <div class="space-y-4">
                    <div class="w-14 h-14 rounded-2xl bg-emerald-50 dark:bg-emerald-900/40 text-[#00843d] dark:text-emerald-300 flex items-center justify-center text-2xl group-hover:bg-[#00843d] group-hover:text-white transition duration-300 shadow-xs border border-emerald-100 dark:border-emerald-700/60">
                        <i class="fa-solid fa-id-card-clip"></i>
                    </div>
                    <div>
                        <span class="text-[10px] font-bold text-emerald-700 dark:text-emerald-300 uppercase tracking-wider bg-emerald-50 dark:bg-emerald-950/80 px-2.5 py-0.5 rounded-full border border-emerald-200/60 dark:border-emerald-800/60">{{ $siteSettings['ptsp_card1_tag'] ?? 'Layanan Izin' }}</span>
                    ...
                    <ul class="text-[11px] text-gray-600 dark:text-slate-300 space-y-1.5 pt-2 border-t border-slate-100 dark:border-slate-800">
                        <li class="flex items-center gap-2"><i class="fa-solid fa-circle-check text-[#00843d] dark:text-emerald-400"></i> <span class="text-gray-700 dark:text-slate-200">{{ $siteSettings['ptsp_card1_point1'] ?? 'Bebas Biaya (Gratis)' }}</span></li>
                        <li class="flex items-center gap-2"><i class="fa-solid fa-circle-check text-[#00843d] dark:text-emerald-400"></i> <span class="text-gray-700 dark:text-slate-200">{{ $siteSettings['ptsp_card1_point2'] ?? 'Tur keliling fasilitas pondok' }}</span></li>
                        <li class="flex items-center gap-2"><i class="fa-solid fa-circle-check text-[#00843d] dark:text-emerald-400"></i> <span class="text-gray-700 dark:text-slate-200">{{ $siteSettings['ptsp_card1_point3'] ?? 'Respon konfirmasi maks 3 hari' }}</span></li>
                    </ul>
                </div>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-3xl p-7 border border-slate-200/90 dark:border-slate-800 shadow-sm hover:shadow-xl hover:border-amber-400 transition-all duration-300 flex flex-col justify-between group hover:-translate-y-1.5">
                <div class="space-y-4">
                    <div class="w-14 h-14 rounded-2xl bg-amber-100/80 dark:bg-amber-900/50 text-amber-600 dark:text-amber-300 flex items-center justify-center text-2xl group-hover:bg-amber-500 group-hover:text-slate-950 transition duration-300 shadow-xs border border-amber-200 dark:border-amber-600/60">
                        <i class="fa-solid fa-handshake"></i>
                    </div>
                    <div>
                        <span class="text-[10px] font-bold text-amber-800 dark:text-amber-300 uppercase tracking-wider bg-amber-50 dark:bg-amber-950/80 px-2.5 py-0.5 rounded-full border border-amber-200/60 dark:border-amber-800/60">{{ $siteSettings['ptsp_card2_tag'] ?? 'Kemitraan & MoU' }}</span>
                        <h3 class="text-base sm:text-lg font-black text-gray-900 dark:text-white mt-2 group-hover:text-[#00843d] dark:group-hover:text-emerald-400 transition">
                    ...
                    <ul class="text-[11px] text-gray-600 dark:text-slate-300 space-y-1.5 pt-2 border-t border-slate-100 dark:border-slate-800">
                        <li class="flex items-center gap-2"><i class="fa-solid fa-circle-check text-amber-600 dark:text-amber-400"></i> <span class="text-gray-700 dark:text-slate-200">{{ $siteSettings['ptsp_card2_point1'] ?? 'MoU resmi berkekuatan hukum' }}</span></li>
                        <li class="flex items-center gap-2"><i class="fa-solid fa-circle-check text-amber-600 dark:text-amber-400"></i> <span class="text-gray-700 dark:text-slate-200">{{ $siteSettings['ptsp_card2_point2'] ?? 'Kemitraan beasiswa & riset' }}</span></li>
                        <li class="flex items-center gap-2"><i class="fa-solid fa-circle-check text-amber-600 dark:text-amber-400"></i> <span class="text-gray-700 dark:text-slate-200">{{ $siteSettings['ptsp_card2_point3'] ?? 'Audiensi langsung pimpinan' }}</span></li>
                    </ul>
                </div>

                <div class="pt-6">
                    <a href="{{ route('layanan.kerjasama') }}" class="w-full bg-amber-500 hover:bg-amber-600 dark:bg-amber-500 dark:hover:bg-amber-400 text-slate-950 dark:text-slate-950 font-black text-xs py-3 px-4 rounded-xl flex items-center justify-center space-x-2 shadow-md transition">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-3xl p-7 border border-slate-200/90 dark:border-slate-800 shadow-sm hover:shadow-xl hover:border-sky-400 transition-all duration-300 flex flex-col justify-between group hover:-translate-y-1.5">
                <div class="space-y-4">
                    <div class="w-14 h-14 rounded-2xl bg-sky-100/80 dark:bg-sky-900/50 text-sky-600 dark:text-sky-300 flex items-center justify-center text-2xl group-hover:bg-sky-600 group-hover:text-white transition duration-300 shadow-xs border border-sky-200 dark:border-sky-600/60">
                        <i class="fa-solid fa-boxes-packing"></i>
                    </div>
                    <div>
                        <span class="text-[10px] font-bold text-sky-800 dark:text-sky-300 uppercase tracking-wider bg-sky-50 dark:bg-sky-950/80 px-2.5 py-0.5 rounded-full border border-sky-200/60 dark:border-sky-800/60">{{ $siteSettings['ptsp_card3_tag'] ?? 'Sarana & Fasilitas' }}</span>
                        <h3 class="text-base sm:text-lg font-black text-gray-900 dark:text-white mt-2 group-hover:text-[#00843d] dark:group-hover:text-emerald-400 transition">
                    ...
                    <ul class="text-[11px] text-gray-600 dark:text-slate-300 space-y-1.5 pt-2 border-t border-slate-100 dark:border-slate-800">
                        <li class="flex items-center gap-2"><i class="fa-solid fa-circle-check text-sky-600 dark:text-sky-400"></i> <span class="text-gray-700 dark:text-slate-200">{{ $siteSettings['ptsp_card3_point1'] ?? 'Aula berkapasitas 1.000 orang' }}</span></li>
                        <li class="flex items-center gap-2"><i class="fa-solid fa-circle-check text-sky-600 dark:text-sky-400"></i> <span class="text-gray-700 dark:text-slate-200">{{ $siteSettings['ptsp_card3_point2'] ?? 'Sound system & multimedia lengkap' }}</span></li>
                        <li class="flex items-center gap-2"><i class="fa-solid fa-circle-check text-sky-600 dark:text-sky-400"></i> <span class="text-gray-700 dark:text-slate-200">{{ $siteSettings['ptsp_card3_point3'] ?? 'Infaq pemeliharaan terjangkau' }}</span></li>
                    </ul>
                </div>

                <div class="pt-6">
                    <a href="{{ route('layanan.sewa') }}" class="w-full bg-sky-600 hover:bg-sky-700 dark:bg-sky-600 dark:hover:bg-sky-500 text-white font-bold text-xs py-3 px-4 rounded-xl flex items-center justify-center space-x-2 shadow-md transition">
