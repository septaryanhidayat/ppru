...
class PpruDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 4. Categories
        $categoriesMap = [
            'taujih' => 'Tausiyah & Khutbah Jum\'at',
